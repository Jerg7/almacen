...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-01-2024 a las 21:34:46
...
(74, '2024_01_06_210805_create_requirements_response_table', 11),
(75, '2024_01_06_222702_create_requirements_table', 11);
...
(2, 2, 2, '2024-01-04 14:58:22', '2024-01-08 14:56:06'),
(3, 2, 3, '2024-01-04 14:58:22', '2024-01-08 14:56:06'),
...
CREATE TABLE `requirements` (
  `id_requirement` bigint(20) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `requirements_response`
--

CREATE TABLE `requirements_response` (
  `id_response` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `warehouses` (`id_warehouse`, `id_product`, `stock`, `created_at`, `updated_at`) VALUES
(14, 1, '3', '2024-01-08 14:56:06', '2024-01-08 14:56:06'),
(15, 2, '0', '2024-01-08 14:56:06', '2024-01-08 14:56:06');
...
ALTER TABLE `requirements`
  ...
  ADD KEY `requirements_id_user_foreign` (`id_user`),
  ADD KEY `requirements_id_product_foreign` (`id_product`),
  ADD KEY `requirements_id_status_foreign` (`id_status`),
  ADD KEY `requirements_id_response_foreign` (`id_response`);

--
-- Indices de la tabla `requirements_response`
--
ALTER TABLE `requirements_response`
...
--
ALTER TABLE `requirements`
  MODIFY `id_requirement` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de la tabla `requirements_response`
--
ALTER TABLE `requirements_response`
  MODIFY `id_response` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `warehouses`
  MODIFY `id_warehouse` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `requirements`
  ADD CONSTRAINT `requirements_id_product_foreign` FOREIGN KEY (`id_product`) REFERENCES `products` (`id_product`),
  ADD CONSTRAINT `requirements_id_response_foreign` FOREIGN KEY (`id_response`) REFERENCES `requirements_response` (`id_response`),
  ADD CONSTRAINT `requirements_id_status_foreign` FOREIGN KEY (`id_status`) REFERENCES `status` (`id_status`),
  ADD CONSTRAINT `requirements_id_user_foreign` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`);
